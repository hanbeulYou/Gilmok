...
export const scene = (): VisibilityScene => ({ schema_version: '0.2.2', srid: 5186, units: 'm', radius_m: 1230, station_radius_m: 1200, school_radius_m: 1000,
  candidate: [0, 0], candidate_wgs84: { lat: 37.5, lng: 127.05 }, floor: 3, candidate_building_id: null,
  containing_building_count: 0, buildings: [], stations: [], schools: [],
  sources: Object.fromEntries(['building_shp', 'building_wfs', 'subway_positions', 'schools'].map(k => [k, { available: true }])),
  coverage: { building_region: 'Gangnam-gu', query_within_loaded_region: true, score_ring_within_loaded_region: true } });
