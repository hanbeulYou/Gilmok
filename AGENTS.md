...
- **S1 데이터 기반** (PR 1~3은 통합 GitHub #6으로 main 반영 완료. PR 4 [GitHub #7](https://github.com/hanbeulYou/Gilmok/pull/7)은 main 머지 완료. PR 5 강남구 footprint·건축물대장·층별개요 승인 후 구현 중이다. S1 전체는 진행 중)
