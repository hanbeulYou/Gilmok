-- Additive v1.3: register total gross area (m²), never floor/exclusive area.
-- Roll back with a new migration restoring the prior public wrapper.
...
begin
 ...
 -- Add authoritative register gross area to both footprint and address paths.
  ...
  if b is not null and b<>'null'::jsonb then
    ...
    if b->'gross_area'='null'::jsonb then
