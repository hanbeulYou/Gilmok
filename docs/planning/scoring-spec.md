...
**현장 진술 대조:** 사용자 진술 “맞은편에서 보임”에 대해 링108점 중 가시점이54점 이상(가중치 미적용)이면 명시한 기준과 일치로 기록한다. 제외점도 생성108점 분모에 남겨 과대해석을 피한다. 실제 맞은편 방향·간판 확인이나 §8의 전체 모델 검증을 완료했다는 뜻은 아니다. 마지막 요청의30·40·60m는 본문20·40·60m와 충돌하여 본문의 점수 반경을 기준으로 해석했다.
