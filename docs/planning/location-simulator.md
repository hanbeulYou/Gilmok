...
> 작성일: 2026-09-16
> 상태: S1 PR 1~6 main 머지 완료(GitHub #6~#9). PR 7 `s1/score-inputs`에서 7개 묶음 score_inputs 통합·실제 6조합 완료 검증 통과, main 반영 전 (v1.15, 2026-09-22, 전 층 배열 추가·머지 보류). 임대동향 공간 연결은 미검증으로 비활성 유지. S1 완료 근거는 [PR 7 v1.2 검증](../validation/pr7-building-all-floors-20260922.md), S2 입력 계약은 data-sources.md 3절을 따른다.
