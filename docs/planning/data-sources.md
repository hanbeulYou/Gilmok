...
> 작성일: 2026-09-16 · 버전: v1.7 (PR 3 지하철·버스 3개월 적재 및 실제 R2 재집계 검증)
...
- **PR 4는 새 세션에서 시작한다.** S2에는 교통의 요일 미분리 일평균과 생활인구의 평일/주말 분리, 버스 누락의 유형·ID 구간 편중을 함께 인계한다. 이번 PR에서 누락 보정·신규 좌표 소스·S2 채점은 구현하지 않았다.
