...
export const academyV0: ScoringPreset = Object.freeze({
  id: 'academy_v0', version: '0.1.2', schema_version: '1.3', radius_primary_m: 800,
  ...
  weights: Object.freeze({ demand: 25, flow: 15, transit: 15, cluster: 15,
    visibility: 10, building: 10, environment: 5, rent_efficiency: 5 }),
  signs: Object.freeze({ demand: 1, flow: 1, transit: 1, cluster: 1,
    visibility: 1, building: 1, environment: 1, rent_efficiency: 1 } as const),
